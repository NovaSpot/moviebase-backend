...
3. if not set, set it first by step 1 or by running curl -X POST "https://xyz.onrender.com/set" -H "Content-Type: application/json" -d '{"key": "movie_1", "value": "Interceptor"}'
